    ...
    <div class="form-modal-container" @click="close">
        <div class="modal-form" @click.stop>
            ...
            <form action="/send/send_1.php" class="modal-form__form">
                ...
                <p class="form-note">Se le aprueba un <span>descuento del 50%</span> en todo su pedido (a partir de dos
                    latas). Deje
                    sus datos de contacto en el siguiente formulario:
                </p>
                <input type="text" name="name" id="name" placeholder="Su nombre:">
                <input type="tel" name="phone" id="phone" placeholder="Su número de teléfono:">
                <button type="button" class="submit-btn">PEDIR >></button>
                <p class="form-note-b">Las solicitudes se aceptan y tramitan las 24 horas del día, los 7 días de la
                    semana. El descuento sólo es válido para pedidos de 2 paquetes o más a través del formulario
                    anterior.
                </p>
            </form>
        </div>
...
.form-modal-container {
    ...
    .modal-form {
        ...
        max-width: 100%;
        margin: 0 auto;
        animation: modal-form-in .1s linear;
        ...
        &__form {
            ...
            input {
                ...
                outline: none;
                margin-bottom: 20px;
                animation: flash 1s ease-in-out .2s;
